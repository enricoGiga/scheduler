...
import {ChangeEventArgs, DropDownListComponent, MultiSelectChangeEventArgs} from '@syncfusion/ej2-angular-dropdowns';
import {DataManager, Predicate, Query} from '@syncfusion/ej2-data';
import {
  BeforeOpenCloseMenuEventArgs,
  ClickEventArgs,
  ContextMenuComponent, ItemModel,
  MenuEventArgs,
  MenuItemModel
...
export class AppComponent {
  ...
  public exportItems: ItemModel[] = [
    {text: 'iCalendar', cssClass: 'e-icons e-schedule-ical-export'},
    {text: 'Excel', cssClass: 'e-icons e-schedule-excel-export'}
  ];
